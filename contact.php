        ...
        <main class="flex-shrink-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
                <div class="container px-5">
                    <a class="navbar-brand" href="index.php"><span class="fw-bolder text-primary">WEL-COME</span></a>
                        ...
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                ...
                                <form id="contactForm" action="contact.php" method="POST">
                                    ...
                                    <!-- Phone number input-->
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="subject" name="subject" type="tel" placeholder="write your subject">
                                        <span class="text-danger"></span>
                                    ...
                                    <!-- Message input-->
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" id="message" name="message" type="text" placeholder="Enter your message here..." style="height: 10rem" data-sb-validations="required"value=""></textarea>
                                        </span>
